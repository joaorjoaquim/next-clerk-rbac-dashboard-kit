  ...
  return (
    <main className="flex flex-col h-[100dvh]">
      <PrivateLayout>
        ...
        <section
          className={`relative flex flex-row w-full flex-1 overflow-hidden`}
        >
          ...
          <div className="flex flex-col w-full flex-1 min-h-0">
            ...
            <div className="flex-1 px-3 lg:pr-3 lg:pl-0 pb-6 overflow-y-auto">
              {children}
            </div>
          </div>
        </section>
